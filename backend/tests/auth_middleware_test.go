...
func TestMiddleware(t *testing.T) {
	...
	cookie := &http.Cookie{
		Name:     "token",
		Value:    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3Mjk2MjM5MDUsImlhdCI6MTcyOTYyMDMwNSwiaXNzIjoiYXV0aC1zZXJ2aWNlIiwic3ViIjoidGVzdHVzZXIifQ.BZc-7UlEvV5oj0P2mfxVYHgXGJjCoH3uDne-3i7e35I",
		MaxAge:   3600,  // 1 hour
